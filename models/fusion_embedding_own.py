...
class FusionBertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids_mask=None, input_ids=None,pinyin_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        if inputs_embeds is None:
            inputs_embeds = self.word_embeddings(input_ids_mask)
